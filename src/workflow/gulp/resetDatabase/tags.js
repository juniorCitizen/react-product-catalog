...
module.exports = (Tags) => {
  ...
  let tags = []
  let names = ['Featured', 'Discontinued', 'Tool Free', 'Heavy Duty', 'Budget', 'Deluxe', 'Child', 'Adult', 'Extra Large', 'Extra Small', 'Discount', 'New', 'Hot Seller', 'Consumer Grade', 'Professional Grade', 'accessories']
