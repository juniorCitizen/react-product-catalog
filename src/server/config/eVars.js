...
module.exports = (() => {
  return {
    ...
    MYSQL_ACCOUNT: eVars.MYSQL_ACCOUNT,
    ...
    CLIENT_ID: eVars.CLIENT_ID,
    CLIENT_SECRET: eVars.CLIENT_SECRET,
    REFRESH_TOKEN: eVars.REFRESH_TOKEN,
    ACCESS_TOKEN: eVars.ACCESS_TOKEN
